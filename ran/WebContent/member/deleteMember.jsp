...
<!-- Site Metas -->
<title>Freshshop-my account</title>
...
%>
				...
				<h3 class="center">회원정보탈퇴</h3>
				</div>
				<form name="fr" action="deleteProc.jsp" method="post" class="needs-validation"  novalidate>
				...
				<div class="mb-3">
					...
					<button type="submit" class="btn hvr-hover">탈퇴</button>
