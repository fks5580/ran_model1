            ...
            <div class="container">
                ...
                <div class="attr-nav">
                    <ul>
                        ...
                        <li class="side-menu"><a href="../shop/cart.jsp">
                ...
                <div class="row">
                        ...
                        <div class="account-box">
                            <div class="service-box">
                                <div class="service-icon">
                                    <a href="../index.jsp"> <i class="fa fa-gift"></i> </a>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="account-box">
                            <div class="service-box">
                                <div class="service-icon">
                                    <a href="updateMember.jsp"><i class="fa fa-lock"></i> </a>
                                </div>
                                <div class="service-desc">
                                    <h4>회원정보 수정</h4>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="account-box">
                            <div class="service-box">
                                <div class="service-icon">
                                    <a href="join.jsp"> <i class="fa fa-location-arrow"></i> </a>
                                </div>
                                <div class="service-desc">
                                    <h4>회원가입</h4>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="account-box">
                            <div class="service-box">
                                <div class="service-icon">
                                    <a href="../shop/cart.jsp"> <i class="fa fa-credit-card"></i> </a>
                                </div>
                                <div class="service-desc">
                                    <h4>장바구니</h4>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="account-box">
                            <div class="service-box">
                                <div class="service-icon">
                                    <a href="../board/questionOrder.jsp"> <i class="fab fa-paypal"></i> </a>
                                </div>
                                <div class="service-desc">
                                    <h4>질문하기</h4>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="account-box">
                            <div class="service-box">
                                <div class="service-icon">
                                    <a href="../shop/shop.jsp"> <i class="fab fa-amazon"></i> </a>
                                </div>
                                <div class="service-desc">
                                    <h4>쇼핑</h4>
