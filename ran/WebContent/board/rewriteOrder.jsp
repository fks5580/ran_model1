...
<!-- 왼쪽메뉴 -->
	...
	<!-- Start 게시글 입력 -->
		...
		<form action="rewriteOrderPro.jsp" method="post">
			<input type="hidden" name="no" value="<%=no%>">
			<input type="hidden" id="main_seq" name="main_seq" value="<%=main_seq %>">
			...
			<table>
				...
				<tr>
					<td>답변글 제목</td>
					<td><input type="text" name="title" id="title" value="[답글]"></td>
				</tr>
				<tr>
					<td>답변글 내용</td>
			...
			<div id="">
				<input type="submit" class="btn hvr-hover" value="글작성" >
