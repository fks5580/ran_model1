...
<!-- 왼쪽메뉴 -->
	...
	<!-- Start 게시글 입력 -->
		...
		<form action="deletereplyOrderPro.jsp" method="post">
				<input type="hidden" name="reply_no" id="reply_no" value="<%=reply_no%>">
				<input type="hidden" name="no" id="no" value="<%=no%>">
				<input type="hidden" name="pageNum" id="pageNum" value="<%=pageNum %>">
			<table>
				<tr>
					<td>댓글 비밀번호</td>
					<td><input type="password" name="reply_pw1" id="reply_pw1"></td>
				</tr>
				
			</table>
			<div>
				<input type="submit" class="btn hvr-hover" value="글삭제" >
			</div>
			</form>
